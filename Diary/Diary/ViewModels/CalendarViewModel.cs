...
namespace Diary.ViewModels
{
    class CalendarViewModel:BaseViewModel
    {
        ...
        public CalendarViewModel()
        {
            ...
            event1.StartTime = new DateTime(2022, 4, 4, 5, 0, 0);
            event1.EndTime = new DateTime(2022, 4, 4, 5, 0, 0);
            event1.Subject = "Family Outing";
            event1.Color = Color.Fuchsia;

            CalendarInlineEvent event2 = new CalendarInlineEvent();
            event2.StartTime = new DateTime(2022, 4, 4, 10, 0, 0);
            event2.EndTime = new DateTime(2022, 4, 4, 10, 0, 0);
